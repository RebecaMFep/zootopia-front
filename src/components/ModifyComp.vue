   ...
   <form @submit.prevent="onSubmit" class="addAnimal">
      ...
      <div class="column right-column">
       <h1> ADD A NEW SPECIE</h1>
         ...
         <select v-model="animal.id_gender" id="inputState1" class="form-select">
         ...
         <label for="inputFamily">Family</label> 
           <select v-model="animal.family" id="inputState2" class="form-select">
         ...
         <select v-model="animal.id_specie" id="inputState3" class="form-select">
         ...
         <select v-model="animal.id_country" id="inputState4" class="form-select">
         ...
         <label for="inputDate">Admission's date</label> 
           ...
           <div class="button">
            <button type="button" id="addBtn" @click="save()">Save</button>
